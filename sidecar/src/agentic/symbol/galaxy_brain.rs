//! Contains the galaxy brain agent which keeps track of everything that is happening
//! inside the code editor at a given time.
//! This controls the whole swarm and can work in background as the events are proceeding
