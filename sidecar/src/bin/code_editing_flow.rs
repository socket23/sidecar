...
async fn main() {
    ...
    let problem_statement = "add a new SearchToolType called Human, which uses Human with CliCommunicator to ask the human a multiple choice question via cli".to_owned();
